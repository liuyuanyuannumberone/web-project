...
!function (a) {
  ...
  return function a(b, c, d) {
      ...
      b.exports = function (a, b, e) {
        function f(b, f) {
          var g, h, i = "less-error-message:" + c.extractId(f || ""),
            ...
            k = a.document.createElement("div"), l = [], m = b.filename || f, n = m.match(/([^\/]+(\?.*)?)$/)[1];
    ...
    7: [function (a, b) {
      ...
      b.exports = function (b, e) {
        ...
        function j(a, b, d, h, i) {
          function j(c) {
            var e = c.contents, g = c.filename, i = c.webInfo,
    ...
    17: [function (a) {
      ...
      var f, g = a("../tree/dimension"), h = a("../tree/color"), i = a("../tree/quoted"), j = a("../tree/anonymous"),
    ...
    27: [function (a, b) {
      b.exports = function () {
        var b = a("../tree/dimension"), c = a("../tree/color"), d = a("../tree/expression"), e = a("../tree/quoted"),
          f = a("../tree/url"), g = a("./function-registry");
        g.add("svg-gradient", function (a) {
          ...
          var h, i, j, k, l, m, n, o, p = "linear", q = 'x="0" y="0" width="1" height="1"', r = {compress: !1},
            s = a.toCSS(r);
    ...
    37: [function (a, b) {
      var c = a("../less-error"), d = a("../tree"), e = a("../visitors"), f = a("./parser-input"), g = a("../utils"),
        h = function i(a, b, h) {
          function j(a, b) {
    ...
    66: [function (a, b) {
      ...
      g.prototype = new c, g.prototype.type = "MixinCall", g.prototype.accept = function (a) {
        ...
        var c, d, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = [], v = [], w = !1, x = [], y = [], z = -1, A = 0,
          B = 1, C = 2;
